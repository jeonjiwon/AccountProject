...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        assertEquals(TranactionType.USE, transactionDto.getTranactionType());
    ...
    void deleteAccountFailed_alreadyUnregistered(){
        ...
        //then
        assertEquals(ErrorCode.ACCOUNT_ALREADY_UNREGISTED, exception.getErrorCode());
    }

    @Test
    @DisplayName("거래 금액이 잔액보다 큰 경우")
    void exceed_UseBalance() {
        //given
        AccountUser user = AccountUser.builder()
                        .id(1L)
                        .name("jiwon").build();
    ...
    void successCancelBalance() {
        ...
        given(transactionRepository.save(any()))
                .willReturn(Transaction.builder()
                        .account(account)
                        .tranactionType(TranactionType.CANCEL)
                        .transactionResultType(TransactionResultType.S)
        ...
        assertEquals(TransactionResultType.S, transactionDto.getTransactionResultType());
        assertEquals(TranactionType.CANCEL, transactionDto.getTranactionType());
